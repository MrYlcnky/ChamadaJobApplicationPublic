        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {STAGES.map((s) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold border-2 ${isCurrent && !isApproved && !isRejected ? "border-sky-500 text-sky-400" : "border-current"}`}
                >
                  {icon}
                </div>
