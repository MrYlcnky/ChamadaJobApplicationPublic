                  ...
                  >
                    {activeTab === "sirket" ? (
                      <>
                        ...
                        <td className="py-3.5 px-4 sm:px-6 text-[10px] sm:text-xs font-bold text-amber-600 uppercase whitespace-nowrap">
                          {item.alanAdi}
                        </td>
                        <td className="py-3.5 px-4 sm:px-6 text-[10px] sm:text-xs font-bold text-emerald-600 uppercase whitespace-nowrap">
                          {item.departmanAdi}
                        </td>
                        <td className="py-3.5 px-4 sm:px-6 text-[10px] sm:text-xs font-bold text-indigo-600 uppercase whitespace-nowrap">
                          {item.pozisyonAdi}
                        </td>
