...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260225033005_InitialCreate') THEN
...
BEGIN
    ...
    VALUES ('20260225033005_InitialCreate', '8.0.2');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260307123749_AddGorevAtamaDetayTablolari') THEN
...
BEGIN
    ...
    CREATE TABLE `Gorevler` (
        ...
        `GorevAdi` longtext CHARACTER SET utf8mb4 NOT NULL,
...
BEGIN
    ...
    CREATE TABLE `GorevAtamaDetaylari` (
        ...
        `BaslangicTarihi` datetime(6) NOT NULL,
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260307123749_AddGorevAtamaDetayTablolari', '8.0.2');
